...
const LogInBoxes = () => {
  ...
  return (
    <div className="flex flex-col gap-7 p-20 w-1/2 text-pink-900">
      ...
      <div className="font-Pacifico font-bold text-[2.65em] mb-5 text-center">
        Welcome Back
      </div>
      <div className="flex flex-col gap-1">
        <div className="font-bold">Email</div>
        <div className="flex justify-between rounded-2xl p-4 pb-1 pt-2  border-gray-300 border-2">
          <input
            type="email"
            id="email"
            name="email"
