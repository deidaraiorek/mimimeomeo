...
const SignUpBoxes = () => {
    ...
    return (
        <div className='flex flex-col gap-6 p-14 text-pink-900 w-1/2'>
            ...
            <button className='p-4 rounded-full bg-pink-400 text-white font-bold text-[1.25em] shadow-lg hover:shadow-xl transition-shadow duration-300' onClick={handleRegister}>Register</button>
